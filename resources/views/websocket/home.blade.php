    ...
    <body>
        <div class="container">
            ...
            <div class="border border-secondary my-4 px-2 py-2">
                ...
                <a class="btn btn-primary" href="/websocket/trigger" target="_blank" rel="noopener noreferrer">Trigger Page</a>
                <a class="btn btn-primary" href="/laravel-websockets" target="_blank" rel="noopener noreferrer">Websocket Dashboard</a>
            </div>
        </div>
    </body>
